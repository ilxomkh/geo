...
const Navbar = () => {
  ...
  return (
    <nav
  className={`fixed w-full z-20 transition-all duration-300 font-oswald ${
    scrolled
  ...
  <div className="max-w-screen-xl mx-auto flex justify-between items-center h-24 p-4">
    ...
    <div className="flex items-center space-x-4">
      <img
        ...
        className="h-8"
      />
      <span className="text-xl text-white hover:text-gray-400 font-semibold">
        РОСГЕОЛОГИЯ
      </span>
    </div>
    ...
    <div className="flex space-x-3 text-white text-sm">
      <button className="hover:text-gray-400">RU</button>
      <span>|</span>
    ...
    <div className="flex items-center space-x-6">
      <div className="hidden md:block text-sm">
        <a href="tel:+998912345678" className="hover:text-gray-400 text-white">
          + 998 91 234 56 78
        </a>
      </div>
      {/* Иконка поиска */}
